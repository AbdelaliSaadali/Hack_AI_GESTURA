...
def log(msg: str) -> None:
    print(f"[retarget_to_fbx_v3_bendonly_clean] {msg}")
...
def animate_fingers_for_frame(armature, bone_map, frame_data=None, frame=None, mirror_x=False, source_scale=1.0, depth_scale=1.0, strength=0.75, palm_twist_strength=0.0):
    ...
    for side in ("left", "right"):
        ...
        apply_simple_palm_twist(
            ...
            palm_normal,
            side,
            strength=palm_twist_strength * 0.35,
            axis=bpy.context.scene.get("gestura_palm_axis", "Y"),
        )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--palm_twist_strength", type=float, default=0.7)
